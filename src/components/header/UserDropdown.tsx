...
// import { getUserPhoto } from "@/helpers/generalHelper";
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200">
                    <li>
                        <DropdownItem
                            ...
                            tag="a"
                            to="/profile"
                            className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700:bg-white/5:text-gray-300"
                        >
                            <svg
                                className="fill-gray-500 group-hover:fill-gray-700:fill-gray-300"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                ...
                <button
                    onClick={signOut}
                    className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700:bg-white/5:text-gray-300 w-full text-left"
                >
                    <svg
                        className="fill-gray-500 group-hover:fill-gray-700:fill-gray-300"
                        width="24"
