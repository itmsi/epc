...
import { useAddCatalogItems } from '@/hooks/useAddCatalogItems';
import { handleKeyPress } from '@/helpers/generalHelper';

export default function AddCatalogItems() {
    const navigate = useNavigate();
    const { id } = useParams(); // ID dari catalog induk
    
    // Use hook khusus untuk Add Items
    const {
        // Search state
        searchInputValue,
    ...
    if (loadingCatalog) {
        return (
            <>
                <PageMeta
                    title="Add Items to Catalog"
                    description="Add new items to existing catalog"
                    image=""
                />
                ...
                <div className="mx-auto p-4 sm:px-3">
                    ...
                    <div className="flex items-center justify-between h-16 bg-white shadow-sm border-b rounded-2xl p-6 mb-8">
                        <div className="flex items-center gap-1">
                            ...
                            <h1 className="ms-2 font-primary-bold font-normal text-xl">Add Items to Catalog</h1>
                            {catalogData && (
                        ...
                        <div className="p-8">
                                    ...
                                    <div>
                                        ...
                                        <CustomAsyncSelect
                                            ...
                                            value={formData.master_category ? 
                                                asyncSelectHook.masterCategoryOptions?.find((mc: any) => String(mc.value) === formData.master_category)
                                                : null
                                            }
                                    ...
                                    {formData.part_id && (
                                        <div>
                                            ...
                                            <CustomAsyncSelect
                                                ...
                                                value={formData.type_id ? asyncSelectHook.detailCatalogOptions?.find((dco: any) => String(dco.value) === formData.type_id) : null}
                                            ...
                                            <div className="mb-6">
                                                ...
                                                <div className="space-y-4 max-h-96 overflow-y-auto font-secondary">
                                                    {formData.parts.length > 0 ? (
                                                                    ...
                                                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                                                                        ...
                                                                        <div className='md:col-span-3'>
                                                                            ...
                                                                            <Input
                                                                                ...
                                                                                placeholder="Enter unit (pcs/set)"
                                                                                className="mt-1"
                                                                            />
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div className={`text-center py-8 text-gray-500 ${validationErrors.parts && 'text-red-600'}`}>
                            ...
                            <div className="flex justify-end gap-4 pt-6 mt-6 border-t border-gray-200">
                                ...
                                >
                                    ...
                                    {submitting ? 'Adding Items...' : 'Add Items'}
                                </Button>
                            </div>
                        </div>
                    </form>
