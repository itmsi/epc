...
import { useCreateEngine } from "@/hooks/usePartCatalogue";
...
export default function CreateEngine() {
    ...
    return (
        <>
            <PageMeta
                title={`Create Engine | MSI`}
                description={`Create engine information`}
                ...
                <div className="mx-auto p-4 sm:px-3">
                    ...
                    <div className="flex items-center justify-between h-16 bg-white shadow-sm border-b rounded-2xl p-6 mb-8">
                        <div className="flex items-center gap-1">
                            ...
                            <h1 className="ms-2 font-primary-bold font-normal text-xl">Create Engine</h1>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
                            <div className="md:col-span-1 p-8 relative space-y-5 min-h-[770px]">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <h2 className="text-lg font-primary-bold font-medium text-gray-900 md:col-span-2">Type Engine</h2>
                                    ...
                                    <div className="md:col-span-2">
                                        <Label htmlFor="engines_name_en">Engine Name - English *</Label>
                                        <Input
                                            id="engines_name_en"
                                    ...
                                    {/* Engine Name Chinese */}
                                    <div className="md:col-span-2">
                                        <Label htmlFor="engines_name_cn">Engine Name - Chinese *</Label>
                                        <Input
                                            id="engines_name_cn"
